...
?>
	...
	<tr>
		...
		<td width="13%" class="right prn_right prn_bold">#<?php echo $row0['byr_no']; ?></td>
	</tr>
	<tr>
	...
	<tr>
		<td rowspan="10" style="vertical-align: top;">
			...
			<br>
			e-Mail : bludspam9@gmail.com<br>
			FB : Bludspam Musi Rawas<br><br>
			
			No. Telp : 0733 454 0039<br>
			Jl. Letda Zakaria Amin BLUD UPT SPAM<br>
			Komplek Perkantoran Pemda Kab. Musi Rawas<br><br>
	...
	<tr>
		<td colspan="2" class="right prn_right">Biaya Pemeliharaan :</td>
