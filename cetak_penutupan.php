<?php
	...
	if($gol_kode=='KW'){
		$que0 	= "SELECT a.* FROM v_penutupan a WHERE a.bulan=$rek_bln AND a.tahun=$rek_thn AND a.kp_kode='".$kopel[0]."' ORDER BY a.dkd_kd";
	}
	else{
		$que0 	= "SELECT a.* FROM v_penutupan a WHERE a.bulan=$rek_bln AND a.tahun=$rek_thn AND a.kp_kode='".$kopel[0]."' ORDER BY a.gol_kode";
	}
	try{
...
?>
  <tr class="<?php echo $klas; ?>">
	...
	<td class="left prn_cell prn_left">	Tutup</td>
