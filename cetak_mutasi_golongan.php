<?php
	...
	$que0 	= "SELECT a.* FROM v_mutasi_golongan a WHERE a.bulan=$rek_bln AND a.tahun=$rek_thn AND a.kp_kode='".$kopel[0]."' ORDER BY a.pel_no"; 
	try{
...
<table width="100%" class="prn_table">
	...
	<tr class="table_cont_btm">
		...
		<td class="center prn_head">Golongan</td>
