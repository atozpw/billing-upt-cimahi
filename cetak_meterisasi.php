<?php
	...
	$que0 	= "SELECT a.* FROM v_meterisasi a WHERE a.bulan=$rek_bln AND a.tahun=$rek_thn AND a.kp_kode='".$kopel[0]."' ORDER BY a.pel_no"; 
	try{
...
<table width="100%" class="prn_table">
	...
	<tr>
		...
		<td colspan="6">: <?php echo $rek_bln; ?> - <?php echo $rek_thn; ?></td>
	</tr>
	<tr>
	...
	<tr class="table_cont_btm">
		...
		<td class="center prn_head">No. SR</td>
		<td class="center prn_head">Nama</td>
		<td class="center prn_head">Alamat</td>
		<td class="center prn_head">DKD</td>
		<td class="center prn_head">Ukuran Meter</td>
		<td class="center prn_head">Remark</td>
		<td class="center prn_head">Stand Lalu</td>
		<td class="center prn_head">Stand Pasang</td>
...
?>
  <tr class="<?php echo $klas; ?>">
	...
	<td class="left prn_cell prn_left"><?php echo $row0['um_ket']; ?></td>
	<td class="left prn_cell prn_left"><?php echo $row0['remark_um_ket']; ?></td>
	<td class="left prn_cell prn_left"><?php echo number_format($row0['sm_angkat']); ?></td>
	<td class="left prn_cell prn_left"><?php echo number_format($row0['sm_pasang']); ?></td>
...
<?php
		...
		if($i>0){
?>
    <tr class="table_cont_btm"><td colspan="11">&nbsp;</td></tr>
<?php
		}
?>
</table>
