...
<h3>Form Pemulihan Password Pengguna</h3>
<hr/>
<div id="<?php echo $targetId; ?>" class="span-18 left">
	...
	<div class="span-15 prepend-top">&nbsp;
		...
		<input type="hidden" class="simpan" name="proses"		value="reset"/>
		<input type="button" class="form_button" value="Reset" onclick="buka('simpan')"/>
	</div>
</div>
</div>
</div>